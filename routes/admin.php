...
use App\Http\Controllers\Admin\VotosController;
...
Route::post('votos/storeVotes/{mesa}', action: [VotosController::class, 'storeVotes'])->name('votos.storeVotes');
...
Route::get('votos/verVotos', action: [VotosController::class, 'verVotos'])->name('votos.verVotos');

//Crear route para ver votos por cargo, con la url: admin/votos/verVotos/{cargo}, donde cargo puede ser: president, senatornac, senatorreg, diputies, andino.
Route::get('votos/verVotos/{cargo}', action: [VotosController::class, 'verResultados'])->name('votos.verResultados');
...
Route::get('getmesas', [DataTableController::class,'mesas'])->name('getmesas');

...
class VoterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($lo) {
            ...
            // Si no se proporciona una foto, se puede asignar una imagen genérica o dejar el campo vacío
            //merge con el request para que se guarde en la base de datos
            $request->merge(['photo_path' => 'photos/generic.png']);

...
class MuestreoController extends Controller
{
    ...
    public function pdf($district_id, $samples, $votes)
    {
        ...
        if (file_exists('storage/images/logo.png')) {
            $pdf->Image('storage/images/logo.png', 10, 8, 30, 30);
        } else {
            // Si el archivo no existe, puedes mostrar un mensaje de error o simplemente omitir la imagen
            $pdf->Cell(0, 10, 'Not Logo', 0, 1, 'C');
        }

            ...
            <form action="{{ route('admin.parties.update', $party) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 col-md-4">
                        ...
                        <input type="numeric" min="0" name="voters" id="voters"
                            class="form-control @error('voters') is-invalid @enderror" value="{{ old('voters') ?? $party->voters }}"
                            maxlength="4" >
                        @error('voters')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group col-sm-12 col-md-4">
                        ...
                        <input type="numeric" name="order" id="order" min="0"
                            class="form-control @error('order') is-invalid @enderror" value="{{ old('order') ?? $party->order }}"
                            maxlength="4" >
                        @error('order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
